...
import random
from rpw.ui.forms import FlexForm, Label, Separator, Button, TextBox,ComboBox
from rpw import ui
...
for key_id in lkey_name:
    ...
    components = [Label('Sheet Number Scope:'),
            TextBox('textbox1', Text="A"),
            Label('Line Pattern:'),
...
if result:
    ...
    for viewsheet in viewsheet_col:
        if result['textbox1'] in viewsheet.SheetNumber:
